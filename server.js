...
var listener = require('services/listener.service')
...
listener.connectToTransactionListner()
...
app.use('/api/products', require('./controllers/api/products.controller'));
app.use('/api/transaction', require('./controllers/api/transactions.controller'));
